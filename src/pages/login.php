...
if(isset($_POST['email']) || isset($_POST['senha'])) {
    ...
    if(strlen($_POST['email']) == 0) {
        echo '<p id="erro-login">Preencha seu e-mail</p>'; /*josevinicius@tjsp.jus.br*/
    } else if(strlen($_POST['senha']) == 0) {
        echo '<p id="erro-login">Preencha sua senha</p>'; /*tjsp12345*/
    } else {
        ...
        if($quantidade == 1) { 
            ...
            echo '<p id="erro-login">Falha ao logar! E-mail ou senha incorretos</p>';
        }
    }
}
?>
