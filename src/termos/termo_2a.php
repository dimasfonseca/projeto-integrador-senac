...
<body>
    ...
    <section>
        <p>
            ...
            Acolho a proposta de transação penal feita pelo Ministério Público e aceita pelo(a) autor(a) do fato, sem
            oposição de seu(sua) defensor(a), e, com fundamento no artigo 76 da Lei 9.099/95, aplico-lhe a pena
            restritiva de direitos consistente em pagamento de prestação pecuniária, que será revertida ao FUNDO
            MUNICIPAL DA CRIANÇA E DO ADOLESCENTE (FUMCAD), no valor de R$ <b>
                <?php echo $_POST["valor-pp"]; ?>
            </b>, no prazo de <b>
                <?php echo $_POST["prazo-pp"]; ?>
            </b>, de acordo, no mais, com a manifestação supra do(a) representante do M.P. Na hipótese de
            descumprimento, resolve-se de pleno direito a presente transação penal, com consequente prosseguimento do
            feito nos seus ulteriores termos. Observo, ainda, que a transação penal não tem natureza jurídica de
